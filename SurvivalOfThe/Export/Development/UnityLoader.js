if (typeof Unity == 'undefined') {function LoadJSCodeBlob(blob, onload)
{
...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Export.data';
    var REMOTE_PACKAGE_BASE = 'Export.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5628545;
      var PACKAGE_UUID = '687dcbe5-dc04-4dc2-83e9-715dc31bb282';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 1677297, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(1677297, 1677318, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1677318, 1680788, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1680788, 4725948, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4725948, 5600920, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5600920, 5628545, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Export.data');

    };
    Module['addRunDependency']('datafile_Export.data');
