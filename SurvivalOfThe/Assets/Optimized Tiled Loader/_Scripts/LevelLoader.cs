...
public class LevelLoader : MonoBehaviour
{
    ...
    */
    ...
    Color[] GetTilePixels(int tileType)
    {
        ...
        {
            int xIndex = (tileType - 1) % TiledLevel.tilesets[0].columns;
            int yIndex = (tileType - 1) / TiledLevel.tilesets[0].columns;
            // Debug.Log();
            return Tileset.GetPixels(xIndex * (int)TilePixelSize.x, 160- (yIndex * (int)TilePixelSize.y), (int)TilePixelSize.x, (int)TilePixelSize.y);
        }
    }
